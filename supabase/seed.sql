...
BEGIN
    ...
    -- Insert type
    INSERT INTO public.type (type_name, user_id) VALUES
    ('50MA-PB', user_id),
    ('BO-50MA', user_id),
    ('Cheat', user_id),
    ('Tightness-ACP', user_id),
    ('21MA-PB', user_id),
    ('VCP', user_id);
    ...
    BEGIN
        ...
        -- Get type IDs
        SELECT id INTO ma50_pb_id FROM public.type WHERE type_name = '50MA-PB';
        SELECT id INTO bo_50ma_id FROM public.type WHERE type_name = 'BO-50MA';
        SELECT id INTO cheat_id FROM public.type WHERE type_name = 'Cheat';
        SELECT id INTO tightness_acp_id FROM public.type WHERE type_name = 'Tightness-ACP';
        SELECT id INTO ma21_pb_id FROM public.type WHERE type_name = '21MA-PB';
        SELECT id INTO vcp_id FROM public.type WHERE type_name = 'VCP';
